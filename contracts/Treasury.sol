...
contract Treasury is ContractGuard, Epoch {
        ...
        updatePrice
    {
        ...
        IBasisAsset(bond).mint(msg.sender, amount.mul(WBTC_PRICE_PRECISION).div(cashPrice));
        ...
        checkOperator
    {
        ...
        uint256 seigniorage = circulatingSupply().mul(percentage).div(WBTC_PRICE_PRECISION);
